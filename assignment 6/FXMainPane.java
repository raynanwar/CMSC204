...
public class FXMainPane extends VBox {
	...
	sourceConnectionComboBox = new ComboBox<>();
	destConnectionComboBox = new ComboBox<>();
	...
	displayTownsButton.setOnAction(event -> {
	    ArrayList<String> towns = graph.getSortedListOfTowns();
	    String result = "";
	...
	displayRoadsButton.setOnAction(event -> {
	    ArrayList<String> roads = graph.getSortedListOfRoads();
	    String result = "";
	...
	addTownButton.setOnAction(event -> {
		...
		alert.showAndWait();
	    } else if (graph.addTown(new Town(townName))) {
		updateComboBoxes();
	...
	findConnectionButton.setOnAction(event -> {
	    ...
	    ArrayList<String> path = graph.getShortestPath(town1, town2);
	...
	ArrayList<String> townList = graph.getSortedListOfTowns();
